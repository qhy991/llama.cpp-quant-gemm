...
def main():
    # Change to the project root directory (parent of bench_web)
    # This allows access to both bench_web/ and definitions/
    ...
    print(f"   Open: http://localhost:{PORT}/bench_web/")
    ...
    with socketserver.TCPServer(("", PORT), APIRequestHandler) as httpd:
        ...
        try:
            webbrowser.open(f'http://localhost:{PORT}/bench_web/')
        except:
            pass
